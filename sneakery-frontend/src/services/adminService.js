...
class AdminService {
  ...
  async getStatsCompare(period = "30d") {
    try {
      const response = await adminApi.get(
        `/analytics/stats-compare?period=${period}`
      );
      return response.data;
    } catch (error) {
      throw this.handleError(error);
  ...
  async updateReviewStatus(id, isApproved) {
    try {
      const response = await adminApi.put(
        `/reviews/${id}/status?isApproved=${isApproved}`
      );
      return response.data;
    } catch (error) {
      throw this.handleError(error);
  ...
  async replyToReview(id, replyText) {
    try {
      const response = await adminApi.post(`/reviews/${id}/reply`, {
        replyText,
      });
      return response.data;
    } catch (error) {
  ...
  async getActivityLogsByUser(userId, page = 0, size = 20) {
    try {
      ...
      const response = await adminApi.get(
        `/activity-logs/user/${userId}?${params}`
      );
      return response.data;
    } catch (error) {
      throw this.handleError(error);
  ...
  async getAllSizes() {
    try {
      const response = await adminApi.get("/sizes");
      return response.data;
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async getSizeById(id) {
    try {
      const response = await adminApi.get(`/sizes/${id}`);
      return response.data;
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async createSize(sizeData) {
    try {
      const response = await adminApi.post("/sizes", sizeData);
      return response.data;
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async updateSize(id, sizeData) {
    try {
      const response = await adminApi.put(`/sizes/${id}`, sizeData);
      return response.data;
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async deleteSize(id) {
    try {
      const response = await adminApi.delete(`/sizes/${id}`);
      return response.data;
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async toggleSizeActive(id) {
    try {
      const response = await adminApi.patch(`/sizes/${id}/toggle-active`);
      return response.data;
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async getAllColors() {
    try {
      const response = await adminApi.get("/colors");
      return response.data;
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async getColorById(id) {
    try {
      const response = await adminApi.get(`/colors/${id}`);
      return response.data;
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async createColor(colorData) {
    try {
      const response = await adminApi.post("/colors", colorData);
      return response.data;
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async updateColor(id, colorData) {
    try {
      const response = await adminApi.put(`/colors/${id}`, colorData);
      return response.data;
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async deleteColor(id) {
    try {
      const response = await adminApi.delete(`/colors/${id}`);
      return response.data;
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async toggleColorActive(id) {
    try {
      const response = await adminApi.patch(`/colors/${id}/toggle-active`);
      return response.data;
    } catch (error) {
      throw this.handleError(error);
    }
